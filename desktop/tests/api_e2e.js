...
server.listen(4567, async () => {
  try {
    ...
    assert.strictEqual(s2.json.entityAffiliations, 'ISA, CIO');
    console.log('  ✅ GET /api/setup/status: Returns configured organization info (country: SN, affiliations: ISA, CIO)');

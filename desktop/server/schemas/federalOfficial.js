...
const federalOfficialSchema = z.object({
  title,
...
const updateFederalOfficialSchema = federalOfficialSchema.partial();

module.exports = { federalOfficialSchema, updateFederalOfficialSchema };

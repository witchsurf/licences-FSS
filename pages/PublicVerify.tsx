...
export const PublicVerify: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white py-4 px-4 flex flex-col items-center">
      {/* Visual Card Display */}
      <div className="mb-6 w-full flex justify-center overflow-hidden py-4 bg-gray-50 rounded-xl border border-gray-100">
        <div className="scale-[1.05] xs:scale-[1.3] sm:scale-110 origin-center">
      ...
      <div className="mt-8 text-center text-[10px] text-gray-400 max-w-xs">

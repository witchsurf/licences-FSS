...
export const FederalOfficialCard: React.FC<FederalOfficialCardProps> = ({ official, side }) => {
  ...
  return (
    <div className="w-[85.6mm] h-[54mm] relative overflow-hidden rounded-2xl bg-white shadow-2xl ring-1 ring-black/5 print:rounded-none print:shadow-none">
      <div className="absolute left-0 top-0 h-[35mm] w-[35mm] overflow-hidden" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}><div className="h-full w-full bg-[linear-gradient(135deg,#00853F_0_33%,#FCD116_33%_66%,#E31B23_66%)]" /></div><span className="absolute left-[10mm] top-[9mm] z-10 text-[18px] leading-none text-[#00853F]">★</span>
